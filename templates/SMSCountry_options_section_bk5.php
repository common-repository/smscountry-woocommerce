...
SMS Solutions, At Your Fingertips.</h1>
    ...
    $tabNames  = array( 'cbGenSettings_tab' => 'API Settings','user_template'=>'User Template','admin_template' => 'Admin template');
      ...
      <div class="wrap">
        ...
        <div style="border:1px solid black;background-color:white;border-radius:5px 5px;" class="genral_setting_div">
            ...
            <p class="submit" style="clear: both;">
              <input type="submit" name="save" id="save" class="button-primary" value="Save Settings" style="margin-left:20px;"/>
