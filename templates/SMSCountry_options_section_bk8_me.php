	...
	$current_url = set_url_scheme( 'http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'] );
	   ...
	   /****** Used for save admin settings********/	  
	    if(isset($_POST['settings-admin_template'])) {
		   $page_refresh=$_POST['settings-admin_template'];
		   	$frm_div=$_POST['frm_div'];
			$frm_btn=$_POST['frm_btn'];
        ...
        <div style="border:1px solid black;background-color:white;border-radius:5px 5px;">
           <div id="div1">
                <ul id="tabs_li">
                    ...
                    <li ><input type="button" id="btn_new_order" class="button-primary"  value="3. New Order Placed"/>
                    </li>
                    <li ><input type="button" id="btn3" class="button-primary"  value="4. Return Order"/>
                    </li>
                    <li ><input type="button" id="btn4" class="button-primary" value="5. Order Status Changed"/>          
                    </li>
                </ul>
                 <input type="hidden" name="hidden_page" val="" />
           </div>
           ...
           <div class="table_div_new_order" style="display:none;">
           	   <table class='form-table' border='0' id='api_settings_tbl'>
                     ...
                     <tr>
                             <td></td>
                             <td><p class='submit' style='clear: both;'><input type='submit' name='save' id='save' class='button-primary' value='Save Settings'/><input type='hidden' name='settings-user_template' value='new_order' /></p></td>
                     </tr>
                     </table>
           ...
           <div id="div1">
            ...
            <div class="table_div9">
                          <h2 class="nav-tab-wrapper">
                              ...
                              <a class='nav-tab nav-tab-active' href="#" id="tab_admin1">New Registered Customers</a>
                         </h2>
            </div>
                       ...
                       <table class="form-table" border="0" id="api_settings_tbl">
                            <tr>
                             ...
                             <tr>
                                ...
                                <td align="left" scope="row"><input type="checkbox" name="settings_admin[txt_check_daily]" value="" size="55" class="weekly"/>&nbsp;Daily&nbsp;&nbsp;&nbsp;<input type="checkbox" name="settings_admin[txt_check_weekly]" value="" size="55" class="mothly"/>&nbsp;Weekly&nbsp;&nbsp;&nbsp;<input type="checkbox" name="settings_admin[txt_check_monthly]" value="" size="55" class="new_checked"/>&nbsp;Monthly
                                  <p class="description">
                   ...
                   <div class="table_div8" style="display:none;" >
					 ...
					 ?>	
                        <table class='form-table' border='0' id='api_settings_tbl'>
                             ...
                             <tr>
                                     <td></td>
                                     <td><p class='submit' style='clear: both;'><input type='submit' name='save' id='save' class='button-primary' value='Save Settings' /><input type='hidden' name='settings-admin_template' value='contact_inquiry' /><input type='hidden' name='frm_div' value='table_div8' /><input type='hidden' name='frm_btn' value='btn_admin4' /></p>
                                     </td>
                             </tr>
                          </table>
	     ...
	     <h2>
          <?php _e( 'SMS History', 'woocommerce_SMSCountry' ); ?>
            ...
            <div style="border:1px solid black;background-color:white;border-radius:5px 5px;">
				...
				/*$mydb= new wpdb('root','','wp_wordpress','localhost');

				$rows = $mydb->get_results("select * from wp_options where option_name='woocommerce_user_template_sign_up'");
					echo "<pre>";
					print_r($rows);
					echo "</pre>";
					
					echo "<pre>";
					print_r($admin_email = get_option( 'woocommerce_user_template_sign_up' )); 
					echo "</pre>";
					*/
                ...
                <div class="filter_div">
                    ...
                    <input type="text" name="search_from_date" value="" id="datetimepicker"/>&nbsp;&nbsp;&nbsp;&nbsp;
                    <label>To Date:</label>
                    <input type="text" name="search_to_date" value="" id="datetimepicker1"/>&nbsp;&nbsp;&nbsp;&nbsp;
                    <label>Type Of SMS:</label>
                    <input type="text" name="type_of_sms" value="" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="button" name="search" class='button-primary search' value="Search"/> 
                </div>
...
/*$(document).ready(function(){
	...
	var div='<?php// echo $frm_div?>';
	//var btn='<?php// echo $frm_btn?>';
	console.log(div);
});
*/</script>
